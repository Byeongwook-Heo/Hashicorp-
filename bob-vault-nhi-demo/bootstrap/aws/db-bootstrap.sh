...
PGPASSWORD="${master_password}" VAULT_ADMIN_PASSWORD="${vault_admin_password}" \
  PGSSLMODE=verify-full PGSSLROOTCERT="${rds_ca}" \
...
\getenv vault_admin_password VAULT_ADMIN_PASSWORD
